...
bool tetrisGameManager::moveBlock(BlockColors status)
{
    /// this is really bad formatted code that looks extremely hard to adjust
    /// this really needs to broken up to if statements
...
bool tetrisGameManager::checkLines()
{
    ...
    /// huh? why do we have a random places being checked?
...
{
    /// where do these number come from? guessing dividing screen space
